...
export function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-around border-t border-slate-200/80 bg-white/80 backdrop-blur-md px-2 pt-2 pb-safe shadow-[0_-4px_15px_-3px_rgba(0,0,0,0.05)] dark:border-slate-800/80 dark:bg-slate-900/80 lg:hidden">
