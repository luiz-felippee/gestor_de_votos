...
import { Map as MapIcon, Cake, User, CalendarDays } from 'lucide-react'
      ...
      <div className="mb-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div ref={mapaRef} className="lg:col-span-2 -mx-4 sm:mx-0">
            <LazyMount 
              fallback={
                <div className="h-[360px] sm:h-[460px] lg:h-[520px] sm:rounded-2xl border-y sm:border border-slate-200 dark:border-slate-800 bg-slate-100/60 dark:bg-slate-800/40 animate-pulse flex items-center justify-center">
